...
function App() {
  const [items, setItems] = useState([
    ...
    },
    {
      id: 7,
      label: 'Banner Image',
      content: '<img src="https://via.placeholder.com/720x80" alt="Banner Image" style="max-width: 100%;font-family: Arial, sans-serif; font-weight: normal; font-size: 16px; color: black; text-align: left; line-height: 1.5; border: 1px solid black;" />',
    },
    {
      id: 8,
  ...
  const handleSaveAsHTML = () => {
    ...
    let leftDropSpaceHTML = `<html><head><title>Left Drop Space Preview</title>${styles}</head><body>`;
  ...
  `;
  previewWindow.document.write(`<html><head><title>Left Drop Space Preview</title>${styles}</head><body>`);
